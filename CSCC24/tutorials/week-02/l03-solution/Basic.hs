...
merge sort. Let's do it in Haskell! (If you haven't heard of it, just read on.)
Also a small exercise in writing a higher-order function for the purpose of
...
inorder IEmpty = []
inorder (INode lt i rt) = inorder lt ++ [i] ++ inorder rt
