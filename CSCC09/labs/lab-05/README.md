[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/wZCkBGYb)
# Storing Data
...
const messages = new Datastore({ filename: 'db/messages.db', autoload: true})
...
To add a user, the frontend sends a POST request to `/api/users/` with the `username` and `picture` using a form (no `fetch` yet): 
